...
echo "=========================="
echo -e "\n🔍 Running Q5 Zero-shot Gemma 3 4B model..."
...
echo -e "\n🔍 Running Q5 Reflection Approach with Gemma 3 4B model..."
...
echo -e "\n📊 Running Q6 Experiments"
echo "=========================="
echo -e "\n🔍 Running Q6 Reflection Approach with Few-shot Gemma 3 12B model..."
...
echo -e "\n📊 Running Q7 Experiments"
echo "=========================="
echo -e "\n🔍 Running Q7 Vector Search-based Few-shot Gemma 3 1B model..."
...
echo -e "\n📊 Running Q8 Experiments"
echo "=========================="
echo -e "\n🔍 Running Q8 Vector Search-based Few-shot Gemma 3 1B model with 1 example..."
...
echo -e "\n🔍 Running Q8 Vector Search-based Few-shot Gemma 3 1B model with 3 examples..."
...
echo -e "\n🔍 Running Q8 Vector Search-based Few-shot Gemma 3 1B model with 5 examples..."
...
echo -e "\n🔍 Running Q8 Vector Search-based Few-shot Gemma 3 1B model with 7 examples..."
...
echo -e "\n📊 Evaluating Q5 Zero-shot Gemma 3 4B results..."
...
echo -e "\n📊 Evaluating Q5 Reflection Approach with Gemma 3 4B results..."
...
echo -e "\n📊 Evaluating Q6 Reflection Approach with Few-shot Gemma 3 12B results..."
uv run run_evaluation.py --results-path results/q6-reflection-approach-few-shot-gemma3:12b*.json

echo -e "\n📊 Evaluating Q7 Vector Search-based Few-shot Gemma 3 1B results..."
uv run run_evaluation.py --results-path results/q7-vector-search-few-shot-gemma3:1b*.json

echo -e "\n📊 Evaluating Q8 Vector Search-based Few-shot Gemma 3 1B results..."
